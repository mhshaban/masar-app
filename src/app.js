...
const VIEW_LOADERS = {
  ...
  students: async () => (await import("./modules/students/students-ui.js?v=2026-09-24-single-source-averages-1")).mountStudentsView,
  ...
  imports: async () => (await import("./modules/imports/imports-ui.js?v=2026-09-24-term-label-no-level-1")).mountImportsView,
};
