...
const VIEW_LOADERS = {
  ...
  cases: async () => (await import("./modules/cases/guidance-ui.js?v=2026-09-16-candidates-excel-1")).mountCasesView,
  support: async () => (await import("./modules/support/support-ui.js?v=2026-09-16-candidates-excel-1")).mountSupportView,
