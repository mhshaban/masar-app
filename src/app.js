...
const VIEW_LOADERS = {
  ...
  cases: async () => (await import("./modules/cases/guidance-ui.js?v=2026-09-14-consent-form-print-1")).mountCasesView,
  support: async () => (await import("./modules/support/support-ui.js?v=2026-09-14-consent-form-print-1")).mountSupportView,
  ...
  forms: async () => (await import("./modules/forms/forms-ui.js?v=2026-09-14-consent-form-print-1")).mountFormsView,
