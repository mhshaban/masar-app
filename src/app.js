...
const VIEW_LOADERS = {
  ...
  plan: async () => (await import("./modules/department-plan/department-plan-ui.js?v=2026-09-16-prep-school-results-1")).mountDepartmentPlanView,
  agenda: async () => (await import("./modules/agenda/agenda-ui.js?v=2026-09-16-prep-school-results-1")).mountAgendaView,
  students: async () => (await import("./modules/students/students-ui.js?v=2026-09-16-prep-school-results-1")).mountStudentsView,
  grades: async () => (await import("./modules/grades/grades-ui.js?v=2026-09-14-cumulative-average-fix-1")).mountGradesView,
  cases: async () => (await import("./modules/cases/guidance-ui.js?v=2026-09-16-prep-school-results-1")).mountCasesView,
  support: async () => (await import("./modules/support/support-ui.js?v=2026-09-16-prep-school-results-1")).mountSupportView,
  ...
  forms: async () => (await import("./modules/forms/forms-ui.js?v=2026-09-16-prep-school-results-1")).mountFormsView,
