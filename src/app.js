...
const VIEW_LOADERS = {
  dashboard: async () => (await import("./modules/dashboard/dashboard-ui.js?v=2026-09-06-polish-1")).mountDashboardView,
  ...
  students: async () => (await import("./modules/students/students-ui.js?v=2026-09-06-polish-1")).mountStudentsView,
  grades: async () => (await import("./modules/grades/grades-ui.js?v=2026-09-06-current-roster-1")).mountGradesView,
  cases: async () => (await import("./modules/cases/guidance-ui.js?v=2026-09-06-polish-1")).mountCasesView,
  support: async () => (await import("./modules/support/support-ui.js?v=2026-09-06-polish-1")).mountSupportView,
  career: async () => (await import("./modules/career/career-ui.js?v=2026-09-06-polish-1")).mountCareerView,
  promoted: async () => (await import("./modules/promoted/promoted-ui.js?v=2026-09-06-polish-1")).mountPromotedView,
  forms: async () => (await import("./modules/forms/forms-ui.js?v=2026-09-06-polish-1")).mountFormsView,
  ...
  audit: async () => (await import("./modules/audit/audit-ui.js?v=2026-09-06-polish-1")).mountAuditView,
  imports: async () => (await import("./modules/imports/imports-ui.js?v=2026-09-06-polish-1")).mountImportsView,
};
const VIEW_OPTIONS = {
