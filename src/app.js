...
const VIEW_LOADERS = {
  ...
  students: async () => (await import("./modules/students/students-ui.js?v=2026-09-24-roster-layout-fix-1")).mountStudentsView,
  ...
  imports: async () => (await import("./modules/imports/imports-ui.js?v=2026-09-23-class-schedules-1")).mountImportsView,
};
