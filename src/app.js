...
const VIEW_LOADERS = {
  ...
  students: async () => (await import("./modules/students/students-ui.js?v=2026-09-23-averages-from-workbook-1")).mountStudentsView,
  ...
  imports: async () => (await import("./modules/imports/imports-ui.js?v=2026-09-23-averages-into-school-tab-1")).mountImportsView,
};
