...
const VIEW_LOADERS = {
  ...
  plan: async () => (await import("./modules/department-plan/department-plan-ui.js?v=2026-09-13-period-order-fix-1")).mountDepartmentPlanView,
  agenda: async () => (await import("./modules/agenda/agenda-ui.js?v=2026-09-13-period-order-fix-1")).mountAgendaView,
  ...
  cases: async () => (await import("./modules/cases/guidance-ui.js?v=2026-09-08-print-1")).mountCasesView,
  support: async () => (await import("./modules/support/support-ui.js?v=2026-09-08-print-1")).mountSupportView,
