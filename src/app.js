...
const VIEW_LOADERS = {
  dashboard: async () => (await import("./modules/dashboard/dashboard-ui.js?v=2026-09-01-daily-priorities-4")).mountDashboardView,
  ...
  forms: async () => (await import("./modules/forms/forms-ui.js?v=2026-08-31-record-edit-1")).mountFormsView,
