...
const VIEW_LOADERS = {
  ...
  students: async () => (await import("./modules/students/students-ui.js?v=2026-09-06-student-experience-1")).mountStudentsView,
  ...
  backup: async () => (await import("./modules/backup/backup-ui.js?v=2026-09-06-agenda-cleanup-1")).mountBackupView,
