...
const VIEW_LOADERS = {
  dashboard: async () => (await import("./modules/dashboard/dashboard-ui.js?v=2026-09-02-print-header-1")).mountDashboardView,
  ...
  forms: async () => (await import("./modules/forms/forms-ui.js?v=2026-09-02-a4-print-1")).mountFormsView,
