...
const VIEW_LOADERS = {
  ...
  students: async () => (await import("./modules/students/students-ui.js?v=2026-09-07-academic-fix-1")).mountStudentsView,
  ...
  promoted: async () => (await import("./modules/promoted/promoted-ui.js?v=2026-09-07-academic-fix-1")).mountPromotedView,
