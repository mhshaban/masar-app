...
import { buildFollowUpReportHtml } from "../../services/report-builders.js?v=2026-09-14-consent-approval-card-1";
...
export async function mountDepartmentPlanView(container) {
  container.innerHTML = `
    <div class="topbar">
      <div><h1>خطة القسم — الإرشاد الأكاديمي والتوجيه المهني</h1><div class="sub">العام الدراسي 2026/2027</div></div>
      <div style="display:flex; gap:8px;">
